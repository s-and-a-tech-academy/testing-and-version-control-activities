      ...
      <div className="bg-white p-8 rounded-xl shadow-2xl w-full max-w-md border border-gray-200">
        ...
        <div className="flex mb-6 space-x-3 items-start"> {/* Use items-start for misalignment */}
          ...
          <button
            ...
            className="px-6 py-2 bg-blue-600 text-white font-semibold rounded-lg shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200 mt-2" // New Bug: mt-2 for misalignment
